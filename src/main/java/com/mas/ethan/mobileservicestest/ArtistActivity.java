...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        databaseTracks = FirebaseDatabase.getInstance().getReference("tracks").child(intent.getStringExtra(ArtistListActivity.ARTIST_ID));
        ...
        textViewArtist.setText(intent.getStringExtra(ArtistListActivity.ARTIST_NAME));
